...
function Stack() {
  return (
    <section name="stack" className="h-screen w-full">
      {/* Container */}
      <div className="container w-full h-full flex flex-col justify-center items-center px-0 xl:px-20">
        <h1 className="text-center text-4xl text-primary font-bold tracking-wider md:text-5xl">
          WebDev Stack
        </h1>
        <p className="text-neutral-content text-sm mb-16">FrontEnd Developer</p>
